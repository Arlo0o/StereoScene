...
class Mask2FormerOccHead(MaskFormerHead):
    ...
    def forward(self, feats, img_metas):
        ...
        ''' 
        Currently, we can only use convolutional based FPN as the pixel decoder 
        Afterwards, we can use self-defined upsamplers and remove this decoder here
        
        the outputs include:
        [1] mask_features (tensor [Batch, C, X, Y, Z]), for final predictions
        [2] multi_scale_memorys (list of tensors [Batch, C, X', Y', Z']), \
                inputs for the transformer decoder
        '''
